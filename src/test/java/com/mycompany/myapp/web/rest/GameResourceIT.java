...
public class GameResourceIT {
    ...
    public void createGame() throws Exception {
        ...
        assertThat(testGame.getLevel()).isEqualTo(DEFAULT_LEVEL);
        assertThat(testGame.getCategorie()).isEqualTo(DEFAULT_CATEGORIE);
        assertThat(testGame.getIdAccount()).isEqualTo(DEFAULT_ID_ACCOUNT);
    }
    ...
    public void updateGame() throws Exception {
        ...
        assertThat(testGame.getLevel()).isEqualTo(UPDATED_LEVEL);
        assertThat(testGame.getCategorie()).isEqualTo(UPDATED_CATEGORIE);
        assertThat(testGame.getIdAccount()).isEqualTo(UPDATED_ID_ACCOUNT);
    }
